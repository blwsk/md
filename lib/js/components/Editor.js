...
function make(post, savePost, _) {
  ...
  newrecord[/* render */9] = (function (self) {
      ...
      var post = match[/* stagedPost */1];
      var updatePost = function (text) {
        var updatedPost = PostRecord$Md.setText(text, post);
      ...
      return React.createElement("div", undefined, React.createElement("div", undefined, React.createElement("button", {
                        ...
                        }, "Save")), match[/* preview */0] !== 0 ? ReasonReact.element(/* None */0, /* None */0, Article$Md.make(post, /* array */[])) : ReasonReact.element(/* None */0, /* None */0, PostEditor$Md.make(post, updatePost, /* array */[])));
    });
